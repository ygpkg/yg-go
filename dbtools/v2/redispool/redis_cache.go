...
func (c *Cache) IsExist(key string) bool {
	...
	if err != nil {
		logs.Errorf("redis_cache call IsExist failed: %v", err)
		return false
	}
	return result > 0
}
...
func (c *Cache) TTL(key string) time.Duration {
	...
	if err != nil {
		logs.Errorf("redis_cache call ExpireTime failed: %v", err)
		return 0
	}
	return result
}
...
func (c *Cache) Get(key string) (string, error) {
	...
	if err != nil {
		if err == redis.Nil {
			logs.Warnf("redis_cache call Get failed: %v", err)
			return "", err
		}
		logs.Errorf("redis_cache call Get failed: %v", err)
		return "", err
	}
	return result, nil
}
...
func (c *Cache) RPop(key string) (string, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call RPop failed: %v", err)
		return "", err
	}
	return result, nil
}
...
func (c *Cache) RPopLPush(src, dst string) (string, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call RPopLPush failed: %v", err)
		return "", err
	}
	return result, nil
}
...
func (c *Cache) LRem(key string, count int64, value string) (int64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call LRem failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) ZAdd(key string, members ...redis.Z) (int64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZAdd failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) ZCount(key string, min, max string) (int64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZCount failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) ZIncrBy(key string, increment float64, member string) (float64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZIncrBy failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) ZRangeWithScores(key string, start, stop int64) ([]redis.Z, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZRangeWithScores failed: %v", err)
		return nil, err
	}
	return result, nil
}
...
func (c *Cache) ZRange(key string, start, stop int64) ([]string, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZRange failed: %v", err)
		return []string{}, err
	}
	return result, nil
}
...
func (c *Cache) ZRangeByScore(key string, by *redis.ZRangeBy) ([]string, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZRangeByScore failed: %v", err)
		return []string{}, err
	}
	return result, nil
}
...
func (c *Cache) ZRangeByScoreWithScores(key string, by *redis.ZRangeBy) ([]redis.Z, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZRangeByScoreWithScores failed: %v", err)
		return nil, err
	}
	return result, nil
}
...
func (c *Cache) ZRem(key string, member ...interface{}) (int64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call ZRem failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) HDel(key string, fields ...string) (int64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call HDel failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) HExists(key string, field string) (bool, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call HExists failed: %v", err)
		return false, err
	}
	return result, nil
}
...
func (c *Cache) HGet(key string, field string) (string, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call HGet failed: %v", err)
		return "", err
	}
	return result, nil
}
...
func (c *Cache) HSet(key string, field, value string) (int64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call HSet failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) HMSet(key string, values ...string) (int64, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call HMSet failed: %v", err)
		return 0, err
	}
	return result, nil
}
...
func (c *Cache) HSetNX(key string, field, value string) (bool, error) {
	...
	if err != nil {
		logs.Errorf("redis_cache call HSetNX failed: %v", err)
		return false, err
	}
	return result, nil
}
...
func GetLock(key string, expired time.Duration) bool {
	...
	if err != nil {
		logs.Errorf("redis_cache call GetLock failed: %v", err)
		return false
	}
	return result
}
...
func UnLock(key string) error {
	...
	if err != nil {
		logs.Errorf("redis_cache call UnLock failed: %v", err)
		return err
	}
	return nil
}
